...
kubectl get pods -n ingress-nginx 4. minikube tunnel (this will block your shell, you will need a new one!)
...
The task itself is _rather_ simple: Create an Ingress Object that allows us to open kubernetestraining.com in our browser and see our application!
